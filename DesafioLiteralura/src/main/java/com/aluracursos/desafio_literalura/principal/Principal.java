...
public class Principal {
    ...
    public void muestraElMenu () {
        var opcion = -1;
        System.out.println("Bienvenido! Por favor selecciona una opción del menu: ");
        while (opcion != 0) {
            var menu = """
    ...
    private  void agregarLibros() {
        ...
        if (!datos.resultados().isEmpty()) {
            ...
            System.out.println("El libro no existe en la API, ingresa otro libro:");
        }
    }
    ...
    private void autoresRegistrados() {
        ...
        System.out.println("Los autores regitrados son:\n");
        autores.stream()
    ...
    private void autoresPorAño() {
        ...
        System.out.println("-----Autores vivos registrados en el año " + año + " son: -----\n");
    ...
    private void listarPorIdioma() {
        ...
        System.out.println("----- los libros descargados en el idioma seleccionado son: -----\n");
    ...
    private void estaditicasApi() {
        ...
        if (opcion == 1) {
            System.out.println("-Estadisticas de desacargas-\n");
            var json = consumoApi.obtenerDatos(URL_BASE);
            Datos datos = conversor.obtenerDatos(json, Datos.class);
            ...
            System.out.println("----- Estadisticas de descargas en la base de datos es: -----\n");
            List<Libros> libros = librosRepository.findAll();
            if (libros.isEmpty()) {
                System.out.println("No hay libros registrados");
                return;
